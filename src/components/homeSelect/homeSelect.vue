            ...
            async _initCarifyData() {
                ...
                if (this.city) {
                    this.city.forEach((pall) => {
                        if (pall.cityName == this.citySelect) {
                            this.flag=true
                           this.$router.push('/main/nextSelect/'+pall.cid)
                        }
                    })
                    if(this.flag==false){
                        alert("错误信息")
